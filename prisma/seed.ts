...
async function main() {
  // Note: User authentication is handled by Supabase
  // This seed file is for development/demo purposes only
  
  // Use a placeholder userId (replace with your actual Supabase user ID when seeding)
  const demoUserId = process.env.DEMO_USER_ID || '00000000-0000-0000-0000-000000000000'
  
  console.log('Seeding with demo user ID:', demoUserId)

  // Create user profile (optional - only if you want to seed profile data)
  try {
    ...
    console.log('Skipping user profile creation (user may not exist in Supabase)')
  }
  ...
  const experiences = [
    {
      userId: demoUserId,
      types: [ExperienceType.internship],
    ...
    {
      userId: demoUserId,
      types: [ExperienceType.education],
    ...
    {
      userId: demoUserId,
      types: [ExperienceType.academic_project],
    ...
    {
      userId: demoUserId,
      types: [ExperienceType.leadership],
    ...
    {
      userId: demoUserId,
      types: [ExperienceType.technical_skills],
    ...
    {
      userId: demoUserId,
      types: [ExperienceType.language_skills],
      title: 'Languages',
      company: null,
      dateRange: null,
    ...
    {
      userId: demoUserId,
      types: [ExperienceType.interests],
